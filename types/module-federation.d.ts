...
declare module "@module-federation/runtime" {
  export interface ModuleFederation {
    name: string;
    loadRemote<T = any>(id: string): Promise<{ default: T }>;
    registerRemotes(remotes: RemoteConfig[]): void;
    registerShared(shared: SharedConfig): void;
    registerPlugins(plugins: FederationRuntimePlugin[]): void;
  ...
  export interface FederationRuntimePlugin {
    ...
    loadRemote?(
      args: LoadRemoteArgs,
      next: (args: LoadRemoteArgs) => Promise<any>
    ): Promise<any>;
  }
  ...
  export function createInstance(options: InitOptions): ModuleFederation;
  export function getInstance(): ModuleFederation;
  export function loadRemote<T = any>(id: string): Promise<{ default: T }>;
  export function registerRemotes(remotes: RemoteConfig[]): void;
  export function registerShared(shared: SharedConfig): void;
